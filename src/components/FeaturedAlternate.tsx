...
const demos: Demo[] = [
  {
    ...
    websiteLink: 'https://track_fly.geoochi.com',
    html: true,
    javascript: true,
    css: true,
  },
      ...
      <div className='flex flex-col gap-20 lg:mt-32 md:gap-40 lg:gap-60'>
        {demos.map((demo, index) => (
          ...
          >
            ...
            <div
              className={`w-full z-10 md:w-1/2 flex flex-col items-center ${
