      ...
      <div className='container'>
        <div className='flex justify-between items-center px-0 py-4 gap-4 sm:px-6 lg:py-8 lg:gap-10'>
          ...
          <div className='flex items-center gap-8'>
            <a href='https://geoochi.space/blog' target={'_blank'} className='text-2xl transition-opacity dark:text-white'>
              Blog
            </a>
            <a href='https://geoochi.space/gallery' target={'_blank'} className='text-2xl transition-opacity dark:text-white'>
              Gallery
            </a>
            <a href='https://geoochi.space/log' target={'_blank'} className='text-2xl transition-opacity dark:text-white'>
              Log
            </a>
